...
SHEET_DEFINITIONS[SHEET_NAMES.ASSIGNMENT_DEFINITION] = {
  headers: [
    '역량과제유형', '템플릿Form', '팀평가여부', '시작오프셋', '기간', '등급구간',
  ...
  notes: {
    ...
    배점: '이 항목의 배점(정수).',
    선택지: '드롭다운으로 보여줄 선택지 목록(쉼표 구분). 판정수식과 동시에 채우지 않음.',
    판정수식: '자동 판정 스프레드시트 수식(문자열). 같은 응답 시트의 열만 참조 가능.',
    기준값: '판정수식이 참조하는 임계값(선택).',
  },
  seedRows: [
    [
      '학습성찰', '', 'FALSE', '0', '7', '90:A;70:B;60:C;0:D',
      '분량', '40', '', '=LEN(응답)>=200', '200',
    ],
    ['학습성찰', '', '', '', '', '', '성실성', '60', '상,중,하', '', ''],
  ],
  calculatedColumns: [],
